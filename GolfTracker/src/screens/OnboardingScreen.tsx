...
const ONBOARDING_SLIDES = [
  ...
  {
    id: 2,
    title: 'Follow the Action Live',
    description: 'Track scores hole-by-hole in real-time as they play. Keep everyone at home updated with minimal effort.',
    icon: 'golf-course',
    iconType: 'MaterialIcons' as const,
    color: '#2196F3',
  },
  {
    ...
    description: 'Take photos and videos of great shots, celebration moments, and the tournament experience to share with family.',
    icon: 'camera',
    iconType: 'MaterialIcons' as const,
    color: '#FF5722',
  },
  {
    ...
    description: 'Easily send updates, photos, and videos back home. Maximum detail with minimal effort.',
    icon: 'share',
    iconType: 'MaterialIcons' as const,
    color: '#9C27B0',
  },
  {
    ...
    description: 'Track multiple rounds across tournament days. Create a complete story of their performance to share.',
    icon: 'trophy',
